...
//       SELECT * FROM \`${companyName}_sales\`
//       WHERE 
//         (sale_type = ? OR ? IS NULL) AND
//         (sale_product = ? OR ? IS NULL) AND
//         (sale_person = ? OR ? IS NULL) AND
//         (sale_customer = ? OR ? IS NULL) AND
//         (created_at = ? OR ? IS NULL)
//     `;

//     const values = [
//       sale_type !== "null" ? sale_type : null,
      
//       sale_product !== "null" ? sale_product : null,
      
//       sale_person !== "null" ? sale_person : null,
     
//       sale_customer !== "null" ? sale_customer : null,
